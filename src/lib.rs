...
#[derive(Debug)]
pub struct NeoCryptoProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NeoCryptoProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NeoCrypto processing");
    
    let mut processor = NeoCryptoProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NeoCryptoProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NeoCryptoProcessor::new(false);
